...
function pk_ajax_dialog_post_share()
{
    ...
    if (empty($post_id)) {
        wp_die(__('Invalid post ID: ', PUOCK) . $post_id);
    }
    ...
    <div class="d-flex justify-content-center w-100">
        ...
        <div data-id="wx" id="wx-share" data-bs-toggle="tooltip" data-bs-html="true"
             data-bs-title="<p class='text-center t-sm mb-1 mt-1'><?php _e('Scan with WeChat', PUOCK); ?></p><img width='120' height='120' class='mb-1' alt='<?php esc_attr_e('WeChat QR Code', PUOCK); ?>' src='<?php echo PUOCK_ABS_URI . pk_post_qrcode($post_link) ?>'/>"
