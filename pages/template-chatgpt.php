                ...
                <div id="posts"
                    ...
                    <div class="mt-20 p-block puock-text">
                        <textarea class="form-control fs14 chat-input" rows="3"
                                  placeholder="<?php echo esc_attr__('Please describe your question here', PUOCK) ?>"></textarea>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="form-check form-switch flex-shrink-0">
                                    <?php if (pk_is_checked('ai_draw_dall_e')): ?>
                                        ...
                                        <label class="form-check-label fs14" for="chat-use-img-mode"><?php _e('AI Drawing', PUOCK) ?></label>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div>
                                <button class="btn btn-primary btn-sm mr-2 chat-submit"><i
                                            class="fa-regular fa-paper-plane me-1"></i><?php _e('Ask Now', PUOCK) ?>
                                </button>
                                <button class="btn btn-dark btn-sm chat-clear-history"><i
                                            class="fa-solid fa-broom me-1"></i><?php _e('Clear', PUOCK) ?>
                                </button>
                            </div>
                        </div>
                    </div>
