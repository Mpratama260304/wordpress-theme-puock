                    ...
                    <div class="p-block">
                        ...
                        <div class="options p-flex-sbc mt20">
                            <div>
                                ...
                                <div class="option puock-bg ta3 t-sm mr-1"><i class="fa-regular fa-eye mr-1"></i><span id="post-views"><?php pk_get_post_views();  ?></span><span><?php _e(' Views', PUOCK) ?></span></div>
                                <?php endif; ?>
                                ...
                                <?php if (is_user_logged_in() && current_user_can('edit_post', $post->ID)): ?>
                                    <a target="_blank" href="<?php echo get_edit_post_link() ?>">
                                        <div class="option puock-bg ta3 t-sm mr-1"><i
                                                    class="fa-regular fa-pen-to-square mr-1"></i><?php _e('Edit', PUOCK) ?></div>
                                    </a>
                                <?php endif; ?>
                            </div>
