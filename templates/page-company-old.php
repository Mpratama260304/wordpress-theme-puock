    ...
    <div id="index-company" class="puock-bg pt20">
        <div class="container text-center">
            ...
            <?php if(!empty(pk_get_option('company_about_a',''))): ?><a
                href="<?php echo pk_get_option('company_about_a') ?>" class="btn btn-outline-secondary"><?php _e('View More', PUOCK); ?></a><?php endif; ?>
        </div>
                ...
                <div class="card mb-4 shadow-sm puock-bg">
                    ...
                    <div class="card-body">
                        ...
                        <?php if(!empty(pk_get_option('company_product_a_'.$i,''))): ?><a
                            href="<?php echo pk_get_option('company_product_a_'.$i) ?>" class="btn btn-ssm btn-outline-secondary"><?php _e('View Now', PUOCK); ?></a><?php endif; ?>
                    </div>
                </div>
                <?php endif;endfor; ?>
            </div>
            ...
            <div class="row mt30">
                ...
                <div class="col-lg-4">
                    ...
                    <p><?php if(!empty(pk_get_option('company_soul_a_'.$i,''))): ?><a
                            ...
                            class="btn btn-ssm btn-outline-secondary"><?php _e('View Now', PUOCK); ?></a><?php endif; ?></p>
                </div>
                <?php endif;endfor; ?>
            </div>
        </div>
