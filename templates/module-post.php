            ...
            <div class="info-top">
                <h2 class="info-title">
                    <?php if (is_sticky()): ?><span class="badge bg-danger"><i
                                class="fa fa-bolt-lightning"></i><?php _e('Sticky', PUOCK) ?></span><?php endif; ?>
                    ...
                    <span class="t-sm c-sub">
                            <?php if (!pk_is_checked('hide_post_views')): ?>
                                <span class="mr-2"><i
                                            ...
                                            class="t-sm d-none d-sm-inline-block"><?php _e(' Views', PUOCK) ?></span></span>
                            <?php endif; ?>
                        <?php if (!pk_post_comment_is_closed()): ?>
                            <a class="c-sub-a" <?php pk_link_target() ?> href="<?php the_permalink() ?>#comments">
                                ...
                                <?php echo get_comments_number() ?><span
                                        class="t-sm d-none d-sm-inline-block"><?php _e(' Comments', PUOCK) ?></span></a>
                        <?php endif; ?>
                    </span>
                </div>
                <div>
