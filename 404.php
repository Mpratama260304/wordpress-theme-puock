...
?>
    ...
    <div id="content" class="mt20 container min-height-container">
        ...
        <div class="text-center p-block puock-text">
            <h3 class="mt20"><?php _e('The resource you visited does not exist!', PUOCK) ?></h3>
            <h5 class="mt20"><span id="time-count-down">3</span><?php _e('Jump to the homepage in seconds', PUOCK) ?></h5>
            <div class="text-center mt20">
                <a class="a-link" href="<?php echo home_url() ?>"><i class="fa fa-home"></i>&nbsp;<?php _e('To homepage', PUOCK) ?></a>
            </div>
        </div>
        <script>
